...
mod tests {
    ...
    #[test]
    #[sequential]
    fn test_aggressive_simplify_case_01() {
    ...
    #[test]
    #[sequential]
    fn test_aggressive_simplify_case_02() {
    ...
    #[test]
    #[sequential]
    fn test_aggressive_simplify_case_03() {
    ...
    #[test]
    #[sequential]
    fn test_aggressive_simplify_case_04() {
        let problem = "(> (* B (+ (+ (* 2 e) (* (- 2) p)) (* (* (- 1) t) (+ (* A t) (* 2 v))))) (^ (+ (* A t) v) 2))".to_string();
        let assumptions =
            "(and (>= t 0) (and (>= v 0) (and (> A 0) (and (> B 0) (and (<= t T) (> T 0))))))"
                .to_string();
        let expected_output =
            "(> (* B (- (* 2 (- e p)) (* t (+ (* t A) (* 2 v))))) (^ (+ (* t A) v) 2))".to_string();
    ...
    #[test]
    #[sequential]
    fn test_aggressive_simplify_case_06() {
    ...
    #[test]
    #[sequential]
    fn test_aggressive_simplify_case_07() {
    ...
    #[test]
    #[sequential]
    fn test_aggressive_simplify_case_08() {
    ...
    #[test]
    #[sequential]
    fn test_aggressive_simplify_case_09() {
    ...
    fn test_aggressive_simplify_case_12() {
        ...
        let assumptions =
            "(and (= T 1) (and (>= i 0) (and (>= s 0) (and (<= s t) (<= t (+ s T))))))".to_string();
    ...
    fn test_aggressive_simplify_case_19() {
        ...
        let assumptions = "(and (or (and (<= x 0) (and (> (+ R x) 0) (< y R))) (or (and (> x 0) (and (< y R) (> R x))) (or (and (< y 0) (or (and (= R (* T v)) (and (> x 0) (or (and (= 0 (+ R y)) (< x R)) (> (+ R y) 0)))) (or (and (< (* T v) (+ R x)) (and (< x R) (or (and (= 0 (+ R y)) (not (= R (* T v)))) (< (+ R y) 0)))) (and (> (+ R x) (* T v)) (and (> (+ R y) 0) (or (and (< R (* T v)) (< (* T v) (* R 2))) (< (* T v) R))))))) (and (>= y 0) (and (> R y) (or (and (> x 0) (= R (* T v))) (and (> (+ R x) (* T v)) (or (and (< R (* T v)) (< (* T v) (* R 2))) (< (* T v) R))))))))) (and (> v 0) (and (> T 0) (> R 0))))".to_string();
        let expected_output =
            "(or (and (= x 0) (< (* T v) R)) (and (< (* T v) (+ R x)) (distinct x 0)))".to_string();
